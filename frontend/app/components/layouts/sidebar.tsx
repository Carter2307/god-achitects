...
const employeeNav: NavItem[] = [
  ...
  {
    label: "Historique",
    href: "/employee/reservations/history",
    icon: (
      <svg className="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const managerNav: NavItem[] = [
  ...
  {
    label: "Historique",
    href: "/manager/reservations/history",
    icon: (
      <svg className="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
      </svg>
    ...
    >
      <div className="flex h-14 items-center border-b px-4">
        ...
        >
          ...
          {!collapsed && (
            <span className="font-semibold text-foreground">ParkRes</span>
          )}
        </button>
      </div>
      ...
      <div className="border-t p-2">
        <button
          onClick={onToggle}
          className="flex w-full items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm text-muted-foreground hover:bg-accent hover:text-accent-foreground"
        >
          <svg
